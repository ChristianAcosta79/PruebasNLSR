...
public:
  ...
  ndn::Name
  buildMidstInterestPrefix(ndn::Name neighbor, InterestType intType) const;
...
private:
  ...
  void
  expressUtInterest(const ndn::Name& neighbor, uint32_t seconds);
  void
  onContentUtData(const ndn::Interest& interest, const ndn::Data& data);
  ...
  static const std::string REGULAR_INTEREST_COMPONENT;
  static const std::string UPDATE_TABLE_INTEREST_COMPONENT;
